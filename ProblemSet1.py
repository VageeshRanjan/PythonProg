...
def problem1_7():
   ...
   if int(base1)==int(base2):
       area = int(base1)*int(height)
       print("The area of a trapezoid with bases",+float(base1),"and",+float(base2),"and height",+ArithmeticErrorfloat(height)," is", area)
   else:
       area = ((int(base1)+int(base2))/2)*int(height)
       print("The area of a trapezoid with bases",+float(base1),"and",+float(base2),"and height",+float(height),"is",area)       
#%%
"""
