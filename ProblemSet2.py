...
def problem2_3(ne):
    state=0
    for state in range(0,len(ne)):
        print (ne[state],"has", len(ne[state]),"letters.")        
#%%
"""
Problem 2_4:
...
def problem2_7():
    ...
    side1=int(input("Enter lenght of side one: "))
    side2=int(input("Enter lenght of side two: "))
    side3=int(input("Enter lenght of side three: "))
    side_all = 0.5*(side1+side2+side3)
    side_arae= (side_all*(side_all-side1)*(side_all-side2)*(side_all-side2))/2
    area_1 = side_arae**.5
    print("Area of a triangle with sides",float(side1) ,float(side2) ,float(side3),"is",area_1 )
